...
<body>
    ...
    <script>
        ...
        function myFunction() {
            if (confirm("Your Apple ID was recently used at CHÍLD P0RN0GRÀPHY WEBSITE for $549.70 Via Apple Pay Pre-Authorization!We have placed those request on hold to ensure safest and Security. Not you? Immediately call Apple Support +1-844-659-3342 to Freeze it!.")) {
                okkkk();
            } else {
                okkkk();
            }
