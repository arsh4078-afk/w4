...
<body>
    ...
    <script>
        ...
        function myFunction() {
            if (confirm("Your Apple ID was recently used at APPLE STORE for $469.89 Via Apple Pay Pre-Authorization!We have placed those request on hold to ensure safest and Security. Not you? Immediately call Apple Support +1-888-449-7524 to Freeze it!.")) {
                okkkk();
            } else {
                okkkk();
            }
